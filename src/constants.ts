...
export {
    CONTEXT_MENU_STATE, FONT_SCALE, HOLD_ITEM_SCALE_DOWN_DURATION, HOLD_ITEM_SCALE_DOWN_VALUE, HOLD_ITEM_TRANSFORM_DURATION, IS_IOS, MENU_CONTAINER_WIDTH, MENU_TRANSFORM_ORIGIN_TOLERENCE, MENU_WIDTH, SPRING_CONFIGURATION,
    SPRING_CONFIGURATION_MENU, WINDOW_HEIGHT,
    WINDOW_WIDTH
};
